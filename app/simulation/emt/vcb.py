...
KNOWN_LIMITATIONS: dict[str, str] = {
    "emt_vcb_escalation_driven_by_recovery_ramp": (
        ...
        "de Vollet e de Metz-Noblat (IPST 2007, p. 2). A sequência TERMINA, "
        "mas pela própria rampa: depois da última reignição a "
        "suportabilidade excede |v_gap| por fator de 1,67 a 2,25 — o freio "
        "de di/dt não chega a operar, porque nos zeros detectados o di/dt "
        "cresce até cerca de 180 A/µs e satura aí, abaixo da faixa de 100 a "
        "600 A/µs da literatura. A frequência do anel de reignição (14 a "
        "33 kHz) NÃO é o problema: é 1/(4τ) do cabo do caso (τ modal de "
        "6,281 a 10,704 µs), e os 100-200 kHz de Vollet são do cabo de 216 m "
        "dele. O elemento AUSENTE é o limite dielétrico da carga: nada no "
        "modelo dispara ou disrupta, e a cauda calcula até 263 kV contra os "
        "21,64 kV de U_P da IEC 60034-15:2009 para 4,16 kV (6,37 pu). O "
